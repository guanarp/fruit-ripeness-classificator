...
for i in range(1,4):
    ...
    image_folder = "./fruit-ripeness-classificator/dataset/images/train/"
    label_output_folder = "./fruit-ripeness-classificator/datasets/labels/train/"
    image_output_folder = "./fruit-ripeness-classificator/datasets/images/train/"
    ...
    for annotation_file in os.listdir(annotation_folder):
        ...
        video_name = annotation_path.split('/')[-1].replace("_modified.txt",'')
        #print(video_name)
        #asdsadasd
